...
object MapUtil {
    ...
    fun <T> MutableMap<T, Int>.decrement(key: T, value: Int = 1) = merge(key, value, Int::minus)
    fun <T> MutableMap<T, Long>.decrement(key: T, value: Long = 1) = merge(key, value, Long::minus)
